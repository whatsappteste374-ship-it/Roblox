...
local function ActivateKatBypass()
    ...
    ShowNotification("DarkForge Bypass", "Proteção ativada para Kat")
...
local function ActivateAsylumLifeBypass()
    ...
    ShowNotification("DarkForge Bypass", "Proteção ativada para Asylum Life")
...
local AdvancedBypass = {
    Execute = function(self)
        ...
        ShowNotification("DarkForge Bypass", "Proteção Universal Ativada")
...
ShowNotification("DarkForge Bypass", "Sistema Carregando...")
task.spawn(function()
    task.wait(1)
